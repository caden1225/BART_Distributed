...
def set_args():
    ...
    parser.add_argument('--batch_size', default=512, type=int, required=False, help='训练的batch size')
    ...
    parser.add_argument('--model_config', default='config/raw_BART_config.json', type=str, required=False,
                        help='设置模型参数')
    parser.add_argument('--data_path', default='/zhengdong3/data/dist_data.txt', type=str, required=False, help='训练集路径')
    ...
    parser.add_argument('--pretrained_model', default='', type=str, required=False,
                        help='预训练的模型的路径')
    parser.add_argument('--tb_log_dir', default='tb_log/', type=str, required=False, help='Tensorboard路径')
    ...
    parser.add_argument('--vocab_path', default='/zhengdong3/pretrained_model/HF_BART_base', type=str, required=False,
                        help='词表路径')
...
if __name__ == '__main__':
    ...
    validate_dataset, train_dataset = load_dataset(logger, tokenizer, args)
